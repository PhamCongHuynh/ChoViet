...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-horizontal">
        <div class="form-group">
            <label class="control-label  col-sm-10">Mật khẩu hiện tại: </label>
            <div class="col-ms-8">
        ...
        <div class="form-group">
            <label class="control-label  col-sm-10">Mật khẩu mới: </label>
            <div class="col-ms-8">
        ...
        <div class="form-group">
            <label class="control-label  col-sm-10">Nhập lại mật khẩu mới: </label>
            <div class="col-ms-8">
