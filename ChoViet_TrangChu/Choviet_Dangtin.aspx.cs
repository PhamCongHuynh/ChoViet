    ...
    public partial class Choviet_Dangtin : System.Web.UI.Page
    {
        ...
        protected void btndangky_Click(object sender, EventArgs e)
        {
            ...
            if (Page.IsValid)
            {
                ...
                News_Controller.insertNew(txthoten.Text, txtsodienthoai.Text, txtemail.Text, txtdiachi.Text, rdloaitin.SelectedValue, txttuade.Text, txtnoidung.Text, UploadImage(image1), UploadImage(image2), UploadImage(image3), UploadImage(image4), UploadImage(image5), UploadImage(image6),txtgia.Text,txtcachthanhtoan.Text,txtvanchuyen.Text,DateTime.Now.ToString(),idME,idMA,idCA,idRE);
